...
public class JavascriptExecutorParameters {
	...
	public void setUp(String browser, String appURL) throws FileNotFoundException, IOException {
	...
	public void tearDown(ITestResult result) throws IOException {
		...
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			String screenShotPath = JavascriptExecutorParametersGrid.getScreenShot(
